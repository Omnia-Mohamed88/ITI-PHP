    ...
    <form action="insert_data.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select name="roomNo" class="form-select" id="roomNo">
                <option value="Application1" <?php echo (isset($old_data['roomNo']) && $old_data['roomNo'] == 'Application1') ? 'selected' : ''; ?>>Application1</option>
                <option value="Application2" <?php echo (isset($old_data['roomNo']) && $old_data['roomNo'] == 'Application2') ? 'selected' : ''; ?>>Application2</option>
                <option value="cloud" <?php echo (isset($old_data['roomNo']) && $old_data['roomNo'] == 'cloud') ? 'selected' : ''; ?>>cloud</option>
            </select>
